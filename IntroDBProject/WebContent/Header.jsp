		...
		<table id="masterTable" cellpadding="0" cellspacing="0">
			<tr>
				<th id="masterHeader" colspan="2">
					<h1>CrowdStarter</h1>
					Project by &lt;Rijad "Dr. Evil" Nuridini, Abhimanyu "Batman" Patel&gt; 
				</th>
			</tr>
			<tr id="masterContent">
				...
				<td id="masterContentMenu">
					...
					<div class="menuDiv2"><a href="Projects?category=Tech">Tech</a></div>
					<div class="menuDiv2"><a href="Projects?category=Superheroes">Super Heroes</a></div>
					<div class="menuDiv2"><a href="Projects?category=Supervillains">Super Villains</a></div>
